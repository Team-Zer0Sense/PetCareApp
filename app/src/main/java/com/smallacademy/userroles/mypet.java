...
public class mypet extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFirestoreList = findViewById(R.id.mypetrview);
        ...
        //query
        CollectionReference docs = fStore.collection("MyPets");
        ...
        adapter = new FirestoreRecyclerAdapter<PetModel, mypet.PetViewHolder>(options) {
            @NonNull
            @Override
            public mypet.PetViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.my_pet_item, parent, false);

                return new mypet.PetViewHolder(view);
            }

            @Override
            protected void onBindViewHolder(@NonNull mypet.PetViewHolder holder, int position, @NonNull PetModel model) {
                holder.model = model;
